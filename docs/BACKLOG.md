...
- [x] **1.1 — Live crossover chart with token-volume slider (WOW MOMENT)**
...
- [x] **1.2 — GPU catalog with amortization + electricity cost model**
...
- [x] **1.3 — API price reference panel**
...
- [x] **1.4 — Breakeven annotation "stamp" animation**
...
- [x] **2.1 — Editable cost assumptions**
...
- [x] **2.2 — Custom-styled GPU picker**
...
- [x] **2.4 — Shareable scenario via URL**
...
- [x] **3.1 — Design polish pass (poster direction, end to end)**
...
- [x] **4.2 — GPU and API price catalog documentation**
